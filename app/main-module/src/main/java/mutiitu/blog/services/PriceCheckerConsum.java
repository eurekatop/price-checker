...
public class PriceCheckerConsum {
    public static String test(String arg) {
        ...
        String url = String.format("https://tienda.consum.es/api/rest/V1.0/catalog/searcher/products?q=%s&limit=20&showRecommendations=true", arg);
        ...
        Request request = new Request.Builder()
                ...
                .addHeader ("X-TOL-ZONE",         "0")
                .addHeader ("X-TOL-CHANNEL",      "1")
                ...
                .addHeader ("X-TOL-LOCALE",       "es")
                .addHeader ("Accept",             "application/json, text/plain, */*")
                .addHeader ("X-TOL-CURRENCY",     "EUR")
                .addHeader ("Referer",            "https://tienda.consum.es/es")
